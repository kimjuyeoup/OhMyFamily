...
public enum SetQuestions {
  ...
  CONTENT3("{name}{a}\n 올해 몇 번째 생일을 맞이하셨나요?", "이거 모르면 진짜 반성해야 댑니다.", "birth", "number", 10L),
  CONTENT4("{name}{b}\n 가장 좋아하는 음식은 무엇인가요?", "참고로 저는 소고기 좋아합니다.", "food", "input", 10L),
  CONTENT5("{name}{b}\n 최근에 빠진 음악은 무엇인가요?", "{name}의 급상승차트♬", "music", "input", 10L),
  CONTENT6("{name}{b}\n 요즘 빠져있는 취미는 무엇인가요?", "", "hobby", "input", 10L),
