...
public class CardCommandService {
  ...
  public void init() {
    ...
    card.setId(1L);
    card.setIcon("https://oh-my-family-bucket.s3.ap-northeast-2.amazonaws.com/potato.PNG");
    ...
    card2.setId(2L);
    card2.setIcon("https://oh-my-family-bucket.s3.ap-northeast-2.amazonaws.com/spoon.PNG");
    ...
    card3.setId(3L);
    card3.setIcon("https://oh-my-family-bucket.s3.ap-northeast-2.amazonaws.com/speak.PNG");
    ...
    card4.setId(4L);
    card4.setIcon("https://oh-my-family-bucket.s3.ap-northeast-2.amazonaws.com/medal.PNG");
    ...
    card5.setId(5L);
    card5.setIcon("https://oh-my-family-bucket.s3.ap-northeast-2.amazonaws.com/nose.PNG");
    ...
    card6.setId(6L);
    card6.setIcon("https://oh-my-family-bucket.s3.ap-northeast-2.amazonaws.com/friend.PNG");
